...
public class WindowUtil {
    ...
    public void update() {
        data[1] = String.format("fps: %s", Gdx.graphics.getFramesPerSecond());
        data[2] = String.format("delta (1/fps): %f", Gdx.graphics.getDeltaTime());
        data[3] = String.format("dimension: %s x %s", Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
        data[4] = String.format("time: %.1f s.", game.getTime());
    }
